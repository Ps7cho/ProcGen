/// @description  scr_colorpicker_set_ui_color(colorpicker_instance, normal_color, focused_color, disabled_color, popup_bg_color, popup_border_color, light_info_text_color, dark_info_text_color);
/// @param colorpicker_instance
/// @param  normal_color
/// @param  focused_color
/// @param  disabled_color
/// @param  popup_bg_color
/// @param  popup_border_color
/// @param  light_info_text_color
/// @param  dark_info_text_color
/**
