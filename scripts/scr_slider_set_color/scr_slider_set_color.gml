/// @description  scr_slider_set_color(slider_instance, indicator_bar_color, focused_out_indicator_color, disabled_indicator_color);
/// @param slider_instance
/// @param  indicator_bar_color
/// @param  focused_out_indicator_color
/// @param  disabled_indicator_color
/**
