/// @description  scr_textbox_set_on_change_cb(textbox_instance, script_asset, [arguments_as_array]);
/// @param textbox_instance
/// @param  script_asset
/// @param  [arguments_as_array]
/**
 * @brief  Sets a callback script to be run when there is a value change in the textbox.
 *
 ...
 *       like spell checking, e-mail validation, etc. You also have the option to set an
 *       on_submit callback script for more expensive stuff.
 *
...
with (o) {
    if (is_string(scr_in)) {
        ...
        scr_textbox_unset_on_change_cb(self);
        return undefined;
    }
