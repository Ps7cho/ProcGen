/// @description  scr_slider_set_sprite(slider_instance, sprite_index, sprite_indicator, sprite_button);
/// @param slider_instance
/// @param  sprite_index
/// @param  sprite_indicator
/// @param  sprite_button
/**
 * @brief  Sets the sprites for the slider. If you don't want to use a button, use
 *         -1 as a forth argument. You may also use scr_slider_show_button(obj, boolien)
