/// @description  scr_slider_set_on_change_cb(slider_instance, script_asset, [arguments_as_array]);
/// @param slider_instance
/// @param  script_asset
/// @param  [arguments_as_array]
/**
 * @brief  Sets a callback script to be run when there is a value change of the slider
 *
 ...
 *       like spell checking, e-mail validation, etc. You also have the option to
 *       set on_release callback script.
 *
...
with (o) {
    if (is_string(scr_in)) {
        ...
        scr_slider_unset_on_change_cb(self);
        return undefined;
    }
