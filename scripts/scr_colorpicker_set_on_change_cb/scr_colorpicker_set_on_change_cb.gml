/// @description  scr_colorpicker_set_on_change_cb(colorpicker_instance, script_asset, [arguments_as_array]);
/// @param colorpicker_instance
/// @param  script_asset
/// @param  [arguments_as_array]
/**
* @brief  Sets a callback script to be run when there is a value change in the colorpicker
*
...
*
* @see scr_colorpicker_unset_on_change_cb
*/
...
with (o) {
    if (is_string(scr_in)) {
        ...
        scr_colorpicker_unset_on_change_cb(self);
        return undefined;
    }
