/// @description scr_dropdown_set_scrollbar_padding(dropdown_instance, top_padding_px, right_padding_px, bottom_padding_px);
/// @param dropdown_instance
/// @param  top_padding_px
/// @param  right_padding_px
/// @param  bottom_padding_px
/**
