/// @description  scr_radio_set_on_change_cb(radio_instance, script_asset, [arguments_as_array]);
/// @param radio_instance
/// @param  script_asset
/// @param  [arguments_as_array]
/**
* @brief  Sets a callback script to be run when there is a value change in the radio.
*
...
*
* @see scr_radio_unset_on_change_cb
*/
