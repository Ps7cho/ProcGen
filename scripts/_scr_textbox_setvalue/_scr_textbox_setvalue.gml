/// @description _scr_textbox_setvalue(t);
/// @param t
...
_txtW = string_width(string_hash_to_newline(value));
_txtH = string_height(string_hash_to_newline(value));
...
if (_txtW > _txtAreaW) {
    ...
    for (var i = 0; _txtW > _txtAreaW; i++) {
        ...
        if (string_width(string_hash_to_newline(_visibleTxt)) <= _txtAreaW) break;
    }
    // set right offset
