/// @description  scr_dropdown_set_on_change_cb(dropdown_instance, script_asset, [arguments_as_array]);
/// @param dropdown_instance
/// @param  script_asset
/// @param  [arguments_as_array]
/**
* @brief  Sets a callback script to be run when there is a value change in the dropdown
*
...
*
* @see scr_dropdown_unset_on_change_cb
*/
...
with (o) {
    if (is_string(scr_in)) {
        ...
        scr_dropdown_unset_on_change_cb(self);
        return undefined;
    }
