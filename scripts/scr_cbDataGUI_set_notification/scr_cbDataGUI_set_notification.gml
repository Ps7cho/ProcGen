/// @description  scr_cbDataGUI_set_notification(message_string, is_error?_boolean, [optional:visible_frame_count]);
/// @param message_string
/// @param  is_error?_boolean
/// @param  [optional:visible_frame_count]
/**
